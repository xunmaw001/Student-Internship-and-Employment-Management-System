    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#E57498","textAlign":"left"}'
                      class="title">工作管理人姓名</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#E57498","borderRadius":"0px","color":"#E57498","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.gongzuoguanlirenName" type="text" v-model="ruleForm.gongzuoguanlirenName" placeholder="工作管理人姓名"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="gongzuoguanlirenPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#E57498","textAlign":"left"}'
                          class="title">头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.gongzuoguanlirenPhoto" :src="ruleForm.gongzuoguanlirenPhoto" mode="aspectFill">
                        </image>
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#E57498","textAlign":"left"}'
                      class="title">工作管理人手机号</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#E57498","borderRadius":"0px","color":"#E57498","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.gongzuoguanlirenPhone" type="text" v-model="ruleForm.gongzuoguanlirenPhone" placeholder="工作管理人手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#E57498","borderRadius":"0px","color":"#E57498","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.gongzuoguanlirenEmail" type="text" v-model="ruleForm.gongzuoguanlirenEmail" placeholder="邮箱"></input>
            </view>
    ...
    export default {
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`gongzuoguanliren`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.gongzuoguanlirenId){
                this.ruleForm.gongzuoguanlirenId = options.gongzuoguanlirenId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
			...
			gongzuoguanlirenPhotoTap() {
                let _this = this;
                this.$api.upload(function(res) {
                    _this.ruleForm.gongzuoguanlirenPhoto = _this.$base.url + 'upload/' + res.file;
                    _this.$forceUpdate();
                    _this.$nextTick(() => {
                        // _this.styleChange()
                    })
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.gongzuoguanlirenName)) {
                    this.$utils.msg(`工作管理人姓名不能为空`);
                    return
                }
				if ((!this.ruleForm.gongzuoguanlirenPhoto)) {
                    this.$utils.msg(`头像不能为空`);
                    return
                }
				if ((!this.ruleForm.gongzuoguanlirenPhone) && (!this.$validate.isMobile(this.ruleForm.gongzuoguanlirenPhone))) {
                    this.$utils.msg(`工作管理人手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.gongzuoguanlirenEmail) && (!this.$validate.isEmail(this.ruleForm.gongzuoguanlirenEmail))) {
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`gongzuoguanliren`, this.ruleForm);
                } else {
                    await this.$api.save(`gongzuoguanliren`, this.ruleForm);
                }
